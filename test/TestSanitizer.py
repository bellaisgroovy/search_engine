...
class TestSanitizer(unittest.TestCase):
    ...
    def test_removes_non_ascii(self):
        actual_line = self.sanitizer.parse_line("日本人 中國的 ascii characters")
        self.assertEqual(["ascii", "characters"], actual_line)

    def test_removes_capitals(self):
        actual_line = self.sanitizer.parse_line("I AM very ANGRY")
        self.assertEqual(["i", "am", "very", "angry"], actual_line)

    def test_removes_whitespace(self):
        actual_line = self.sanitizer.parse_line("    i   declare the  eeee wo hooo       a      - to    ")
    ...
    def test_returns_list(self):
        actual_line = self.sanitizer.parse_line("hi")
